...
namespace PacketProtobuf
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string templatePath = Path.Combine("..", "Template", "PacketHandler.h");
        ...
        static void GenerateHandlerFile(string className, List<string> packets, string templatePath, string outputDir)
        {
