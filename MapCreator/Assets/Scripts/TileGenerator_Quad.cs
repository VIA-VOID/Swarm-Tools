...
public class TileGenerator_Quad : MonoBehaviour
{
    ...
    public PathFinderEnum createStatus;
        ...
        if (Mouse.current.leftButton.isPressed)
        {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                if (quadTiles.ContainsKey(pos) && quadTiles[pos].CompareTag("QuadTile"))
                {
                    ...
                    if (createStatus == PathFinderEnum.EraseToNormal)
                    {
                    ...
                    if (createStatus == PathFinderEnum.SetStartPoint)
                    {
                    ...
                    if (createStatus == PathFinderEnum.SetEndPoint)
                    {
                    ...
                    if (createStatus == PathFinderEnum.SetWater)
                    {
                        TileScript getTileScript = selectedTile.gameObject.GetComponent<TileScript>();
