...
public class TileGenerator_Hex : MonoBehaviour
{
    ...
    public PathFinderEnum pathFinderEnum;
        ...
        if (Mouse.current.leftButton.isPressed)
        {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                if (hexTiles.ContainsKey(pos) && hexTiles[pos].CompareTag("HexTile"))
                {
                    ...
                    if (pathFinderEnum == PathFinderEnum.EraseToNormal)
                    {
                    ...
                    if (pathFinderEnum == PathFinderEnum.SetStartPoint)
                    {
                    ...
                    if (pathFinderEnum == PathFinderEnum.SetEndPoint)
                    {
                    ...
                    if (pathFinderEnum == PathFinderEnum.SetWater)
                    {
                        TileScript getTileScript = selectedTile.gameObject.GetComponent<TileScript>();
